...
<html lang="en">
    <head>
        ...
        <!-- Plugins CSS -->
        <link href="nuevo/plugins.css" rel="stylesheet">
        <!-- REVOLUTION STYLE SHEETS -->
        <link rel="stylesheet" type="text/css" href="nuevo/settings.css">
        <!-- REVOLUTION LAYERS STYLES -->
        <link rel="stylesheet" type="text/css" href="nuevo/layers.css">
        <!-- REVOLUTION NAVIGATION STYLES -->
        <link rel="stylesheet" type="text/css" href="nuevo/navigation.css">
    ...
    <body>
        ...
        <div class="position-relative overflow-hidden p-3 p-md-5 m-md-3 text-center bg-light">
            <div class="col-md-5 p-lg-5 mx-auto my-5">
                ...
                <a class="btn btn-outline-secondary" href="#">Base de datos</a>
            </div>
        ...
        <script type="text/javascript" src="nuevo/plugins.js"></script> 
        <script type="text/javascript" src="nuevo/custom.js"></script> 
        <!-- load cubeportfolio -->
        <script type="text/javascript" src="nuevo/jquery.cubeportfolio.min.js"></script>
        <!-- REVOLUTION JS FILES -->
        <script type="text/javascript" src="nuevo/jquery.themepunch.tools.min.js"></script>
        <script type="text/javascript" src="nuevo/jquery.themepunch.revolution.min.js"></script>
        <!-- SLIDER REVOLUTION 5.0 EXTENSIONS  (Load Extensions only on Local File Systems !  The following part can be removed on Server for On Demand Loading) -->	
        <script type="text/javascript" src="nuevo/revolution.extension.actions.min.js"></script>
        <script type="text/javascript" src="nuevo/revolution.extension.carousel.min.js"></script>
        <script type="text/javascript" src="nuevo/revolution.extension.kenburn.min.js"></script>
        <script type="text/javascript" src="nuevo/revolution.extension.layeranimation.min.js"></script>
        <script type="text/javascript" src="nuevo/revolution.extension.migration.min.js"></script>
        <script type="text/javascript" src="nuevo/revolution.extension.navigation.min.js"></script>
        <script type="text/javascript" src="nuevo/revolution.extension.parallax.min.js"></script>
        <script type="text/javascript" src="nuevo/revolution.extension.slideanims.min.js"></script>
        <script type="text/javascript" src="nuevo/revolution.extension.video.min.js"></script>
        <script>
            /**Hero  script**/
            var tpj = jQuery;
